...
version 2016-12-18"
  ...
  (let ((-style
    ...
    (insert
     (cond
      ((= -style 0)
       (format-time-string "<%Y-%m-%d %A>") ; "<2016-10-10>"
       )
      ((= -style 1)
...
Version 2017-01-21"
  ...
  (xah-fly--define-keys
   ...
   '(
     ...
     ("B" . (lambda () (interactive) (execute-kbd-macro (kbd "M-,"))))
     ...
     ("c" . previous-line)
     ("d" . (lambda () (interactive) (xah-beginning-of-line-or-block)))
     ...
     ("n" . forward-char)
     ("N" . switch-window-mvborder-right)
     ("p" . replace-char)
     ("q" . xah-cut-line-or-region)
     ("r" . forward-word)
     ("/" . call-last-kbd-macro)
     ("?" . apply-macro-to-region-lines)
     ("s" . (lambda () (interactive) (xah-end-of-line-or-block)))
     ("t" . next-line)
     ("T" . switch-window-mvborder-down)
